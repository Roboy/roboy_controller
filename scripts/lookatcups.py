...
def main():
    ...
    with sq:
        ...
        # Sequence.add('LOOKATCUPS', SimpleActionState('/Roboy/MoveEndEffector',
        #                                          roboy_communication_control.msg.MoveEndEffectorAction,
        #                                          goal=roboy_communication_control.msg.MoveEndEffectorGoal(
        #                                              endEffector='head',
        #                                              type=2,
        #                                              q_target=[0, 0, 0.5, 0], sendToRealHardware=False,
        #                                              timeout=30, tolerance=0.01)))
        Sequence.add('MOVETOCUP', SimpleActionState('/Roboy/MoveEndEffector',
                                                     roboy_communication_control.msg.MoveEndEffectorAction,
                                                     goal=roboy_communication_control.msg.MoveEndEffectorGoal(
                                                         pose=pose,
                                                         endEffector='wrist_left_1',
                                                         type=1, sendToRealHardware=True,
