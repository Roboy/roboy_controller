...
private:
    std::map<std::string, double> prevVelocity;
private:
...
private:
    ...
    void setXylophonePose() {
        ...
        const ignition::math::Vector3d *pos = new ignition::math::Vector3d(xylophone_world_pos.getOrigin().getX(),
                                                                           xylophone_world_pos.getOrigin().getY(),
                                                                           xylophone_world_pos.getOrigin().getZ());
